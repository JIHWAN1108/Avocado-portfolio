...
public class MealkitController {
	...
	//1~5번 추천 세트로 이동
		@RequestMapping(value = "/chooseSet", params = "category")	//values가 chooseSet이고 params가 category여야 열로온다.
		public String setList1(Model model, String category) {		//파라미터 이름이랑 같게 하면 그 파라미터 값이 여기 자동으로 담김.
